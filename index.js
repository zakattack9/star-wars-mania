let buildHtmlElements = (title, director, episode, producer, opening_crawl, release) => {
  ...
  let childrenElements = [[$('<div class="title"></div>'), 'Title: ' + title], [$('<div class="director"></div>'), 'Director: ' + director], [$('<div class="episode"></div>'), 'Episode: ' + episode], [$('<div class="producer"></div>'), 'Producer: ' + producer], [$('<div class="opening_crawl"></div>'), 'Opening Crawl: ' + opening_crawl], [$('<div class="release"></div>'), 'Release: ' + release]];
